...
class ChromatogramApp:
    ...
    def setup_tab_style(self):
        ...
        style_rows = [
            ("Линии графиков", 'line_width', 0.5, 100), ("Толщина рамки", 'spine_width', 0.1, 3),
    ...
    def export_style(self):
        ...
        if path:
            ...
            data['convert_sec_to_min'] = self.convert_sec_to_min_var.get() # Сохраняем настройку
    ...
    def import_style(self):
        ...
        if path:
            try:
                ...
                self.reapply_offset_to_all_plots() # Применяем смещение и перевод времени
                self.refresh_plots(force=True)
            except Exception as e:
