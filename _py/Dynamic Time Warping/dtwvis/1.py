...
# НОВОЕ: ПРОРЕЖИВАНИЕ ЛИНИЙ СВЯЗКИ ---
# Укажите, какую по счету линию рисовать. 
# Если точек ~400, шаг 20 нарисует около 20 аккуратных линий.
LINE_STEP = 20 
path_sampled = path[::LINE_STEP] 

# Строим график
fig, ax = dtwvis.plot_warping(s1, s2, path_sampled)
fig.suptitle(f"DTW сопоставление (Окно={WINDOW_SIZE}):\n{names[0]} и {names[1]}", fontsize=14)
